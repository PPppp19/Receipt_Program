...
<html>  
    ...
    <head>
        ...
        <title>Receipt : Report RP03</title>
        <style>
                ...
                <div class="row">
                    <div class="panel panel-default container">
                        <div class="panel-heading" style="background-color: #999999">
                            <h3 class="panel-title"> <font color="#FFFFFF" >Receipt : Report RP03</font></h3>
                        </div>
                            ...
                            <form  method="GET"  id="MyForm" action="./Report" >
                                ...
                                <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-md-offset-5 col-lg-5 col-md-5" style="width: 60%">
                                        <button class="btn btn-success form-control " style="width: 25%" id="vReport" name="vReport" type="submit" value="RP03_EXCEL">GET EXCEL</button>
                                    </div>
                                    <br><br>
                                    <div class="col-md-offset-5 col-lg-5 col-md-5" style="width: 60%">
                                        <button class="btn btn-danger form-control " style="width: 25%" id="vReport" name="vReport" type="submit" value="RP03_PDF">GET PDF</button>
                                    </div>
                                </div>
                            </form>
                        </div>
