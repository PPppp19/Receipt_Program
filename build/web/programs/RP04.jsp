                            ...
                            <form  method="GET"  id="MyForm" action="./Report" >
                                ...
                                <div class="row col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="col-md-offset-5 col-lg-5 col-md-5" style="width: 60%">
                                        <button class="btn btn-success form-control " style="width: 25%" id="vReport" name="vReport" type="submit" value="RP04_EXCEL">GET EXCEL</button>
                                    </div>
                                    <br><br>
                                    <div class="col-md-offset-5 col-lg-5 col-md-5" style="width: 60%">
                                        <button class="btn btn-danger form-control " style="width: 25%" id="vReport" name="vReport" type="submit" value="RP04_PDF">GET PDF</button>
                                    </div>
                                </div>
                            </form>
                        </div>
