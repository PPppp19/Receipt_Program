...
//            var Balance = (parseFloat(AmtRCNO) + parseFloat(AmtExpense)) - parseFloat(AmtInv);
            ...
            if (bankcharge.toString() === "0.00") {

                Balance = (parseFloat(AmtRCNO)) - (parseFloat(AmtInv) - parseFloat(AmtExpense) + parseFloat(bankcharge));

            } else {
//                Balance = (parseFloat(AmtRCNO)-parseFloat(bankcharge)+parseFloat(AmtExpense)) - (parseFloat(AmtInv) + parseFloat(AmtExpense) + parseFloat(bankcharge));
                Balance = (parseFloat(AmtRCNO)) - (parseFloat(AmtInv) - parseFloat(AmtExpense) + parseFloat(bankcharge));

//                Balance = ((parseFloat(AmtRCNO)-parseFloat(bankcharge))  + parseFloat(AmtExpense)) - parseFloat(AmtInv) + parseFloat(bankcharge);
