                ...
                controller: {
                    loadData: function (filter) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            data: {
                                page: "Call_GridBankMappingnewDEPOSIT",
                                cono: cono,
                                divi: divi,
                                location: locations,
                                type: 'TRANSFER'
        ...
        function SearchReceipt(RCNO) {
            ...
            $.ajax({
                ...
                $.each(response, function (i, obj) {
                    ...
                    if (obj.HC_TYPE === "TRANSFER_DEPOSIT") {
                        document.getElementById("transfer").checked = true;
                        radiobtn();
...
//                            if (radioValue !== "TRANSFE_DEPOSIT" && $("#vREAMT").val().replace(/,/g, '') !== "0.00") {
...
//                            }
 ...
 alert(count); 
                ...
                alert("BM_AMT AND RC_AMT ARE NOT EQUAL PLEASE CHECK ");
            }
        ...
        $("#vSAVELOSTRC").click(function (e) {
            ...
            if (radioValue === 'TRANSFER_DESOSIT') {
                HC_PYDT = $("#vDTTF").val();
                var input = $("#vBKTF").val();
                var fields = input.split(',');
                HC_ACCODE = fields[0];
